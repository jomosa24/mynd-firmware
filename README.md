...
- Enable the *Web SSH* feature and open a terminal webpage by: 
  ...
  - ```sh
      curl -sSL https://raw.githubusercontent.com/jomosa24/mynd-firmware/MYNDberry/Projects/Mynd/src/tasks/rpi/daemon_install/install_mynd_berry.sh | sudo bash -s
      ```
